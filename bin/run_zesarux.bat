...
cd %ZESARUX_HOME% && zesarux.exe --noconfigfile --machine tbblue --enabletimexvideo --enablekempstonmouse --tbblue-fast-boot-mode --quickexit --enable-esxdos-handler --esxdos-root-dir %GAMEDIR% %GAMEDIR%\zxnext_dual_vt_sound.nex
